  ...
  return (
    <div className="space-y-8">
      ...
      <div className="mt-12 gradient-secondary rounded-2xl p-8 md:p-12 space-y-6">
        <div className="text-center space-y-4">
          <h2 className="text-3xl font-bold">About Pet Name Generator</h2>
          <div className="prose prose-lg max-w-none text-muted-foreground">
            <p>
              Discover how our pet name generator creates perfect names for your beloved companions 
              by combining meaningful words and traits. Whether you have dogs, cats, birds, or 
              exotic pets, find the perfect name.
            </p>
